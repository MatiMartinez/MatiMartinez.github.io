  ...
  return (
    <article className='main-about container' id='main-about'>
      <section className='about-title'>
        <h1>Mati Martinez</h1>
        <h2>FULLSTACK DEVELOPER | MENDOZA - ARGENTINA</h2>
        <p>
          Hola! Soy <b>Matias</b>, Desarrollador de software, tengo un gran interés por el Frontend, React y TypeScript.
        </p>
      </section>
      <section className='about-cv'>
        <a href={Pdf} className='about-a-cv' without rel='noopener noreferrer' target='_blank' type='application/pdf'>
      ...
      <section className='about-content'>
        <div className='row about-row'>
          <div className='col-12 col-md-6 col-lg-4 about-col'>
            <p>
              En mis años de secundaria solía editar mis propios videos con herramientas como Sony Vegas Pro o Adobe
              After Effects
            </p>
          ...
          <div className='col-12 col-md-6 col-lg-4 about-col'>
            ...
            <p>
              ...
              <b> Arte y Diseño Multimedial</b> por el hecho de hacer algo que me gustaba. Aqui fue mi primer
              acercamiento al <b>Desarrollo Web </b>
          ...
          <div className='col-12 col-md-8 col-lg-4 about-col'>
            ...
            <p>
              Luego de 1 año de estudio, decidi cambiar mi rumbo y estudiar la Tecnicatura en Programación en la
