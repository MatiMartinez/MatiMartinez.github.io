  ...
  return (
    <article className="main-about container" id="main-about">
      <section className="about-title">
        ...
        <p>
          Hola! Soy <b>Matias</b>, Desarrollador Junior, tengo un gran interés
          en Front-End, React y JavaScript.
        </p>
      </section>
        ...
        <div className="row about-row">
          ...
          <div className="col-12 col-md-6 col-lg-4 about-col">
            ...
            <p>
              ...
              <b> Arte y Diseño Multimedial</b> por el hecho de hacer algo que
              me gustaba. Aqui fue mi primer acercamiento al{" "}
              <b>Desarrollo Web </b>
          ...
          <div className="col-12 col-md-8 col-lg-4 about-col">
            ...
            <p>
              ...
              Tecnicatura en Programación en la Universidad Tecnológica
              Nacional.
            </p>
          </div>
        </div>
